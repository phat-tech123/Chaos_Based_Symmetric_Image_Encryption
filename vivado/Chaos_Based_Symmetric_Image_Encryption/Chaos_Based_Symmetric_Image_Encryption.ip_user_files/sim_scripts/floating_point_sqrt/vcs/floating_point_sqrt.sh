...
#
# Script generated by Vivado on Tue Nov 04 19:39:21 +07 2025
...
#
# Usage        : floating_point_sqrt.sh
#                floating_point_sqrt.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                floating_point_sqrt.sh [-reset_run]
#                floating_point_sqrt.sh [-reset_log]
#                floating_point_sqrt.sh [-help]
#
...
#                script (type 'floating_point_sqrt.sh -help' for more information).
#
...
# script info
echo -e "floating_point_sqrt.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./floating_point_sqrt.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.floating_point_sqrt xil_defaultlib.glbl -o floating_point_sqrt_simv
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/vinhphat-josh/Documents/Vivado/Chaos_Based_Symmetric_Image_Encryption/Chaos_Based_Symmetric_Image_Encryption.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key floating_point_sqrt_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc floating_point_sqrt_simv.daidir vcs_lib c.obj)
...
Usage: floating_point_sqrt.sh [-step]\n\
Usage: floating_point_sqrt.sh [-lib_map_path]\n\
Usage: floating_point_sqrt.sh [-reset_run]\n\
Usage: floating_point_sqrt.sh [-reset_log]\n\
Usage: floating_point_sqrt.sh [-keep_index]\n\
