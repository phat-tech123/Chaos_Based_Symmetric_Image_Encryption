...
#
# Script generated by Vivado on Mon Mar 16 17:02:35 +07 2026
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : chaos_cryptor_0.sh
...
#
# Usage        : chaos_cryptor_0.sh
#                chaos_cryptor_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                chaos_cryptor_0.sh [-reset_run]
#                chaos_cryptor_0.sh [-reset_log]
#                chaos_cryptor_0.sh [-help]
#
...
#                script (type 'chaos_cryptor_0.sh -help' for more information).
#
...
# script info
echo -e "chaos_cryptor_0.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./chaos_cryptor_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.chaos_cryptor_0 xil_defaultlib.glbl -o chaos_cryptor_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./chaos_cryptor_0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key chaos_cryptor_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc chaos_cryptor_0_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./chaos_cryptor_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: chaos_cryptor_0.sh [-help]\n\
Usage: chaos_cryptor_0.sh [-step]\n\
Usage: chaos_cryptor_0.sh [-lib_map_path]\n\
Usage: chaos_cryptor_0.sh [-reset_run]\n\
Usage: chaos_cryptor_0.sh [-reset_log]\n\
Usage: chaos_cryptor_0.sh [-keep_index]\n\
Usage: chaos_cryptor_0.sh [-noclean_files]\n\n\
