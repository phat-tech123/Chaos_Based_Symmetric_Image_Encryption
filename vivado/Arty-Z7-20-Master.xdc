...
#create_clock -add -name sys_clk_pin -period 100000.00 -waveform {0 50000} [get_ports { clk }];#set

create_clock -add -name sys_clk_pin -period 7.00 -waveform {0 3.500} [get_ports { s00_axi_aclk }];#set
...
#### LEDs
#set_property -dict { PACKAGE_PIN R14    IOSTANDARD LVCMOS33 } [get_ports { randomness }]; #IO_L6N_T0_VREF_34 Sch=LED0
#set_property -dict { PACKAGE_PIN P14    IOSTANDARD LVCMOS33 } [get_ports { clk_debug }]; #IO_L6P_T0_34 Sch=LED1
...
#### Buttons
#set_property -dict { PACKAGE_PIN D19    IOSTANDARD LVCMOS33 } [get_ports { clr }]; #IO_L4P_T0_35 Sch=BTN0
...
### Pmod Header JA
##set_property -dict { PACKAGE_PIN Y18   IOSTANDARD LVCMOS33 } [get_ports { randomness }]; #IO_L17P_T2_34 Sch=JA1_P (Pin 1)
...
##set_property -dict { PACKAGE_PIN Y9    IOSTANDARD LVCM         OS33 } [get_ports { ck_io41 }]; #IO_L14P_T2_SRCC_13  Sch=CK_IO41
...
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets pdl_0/z4]
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets pdl_1/z4]
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets pdl_2/z4]
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets pdl_3/z4]
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets pdl_4/z4]
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets pdl_5/z4]
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets pdl_6/z4]
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets pdl_7/z4]
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets pdl_8/z4]
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets pdl_9/z4]
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets pdl_10/z4]
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets pdl_11/z4]
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets pdl_12/z4]
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets pdl_13/z4]
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets pdl_14/z4]
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets pdl_15/z4]
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets pdl_16/z4]
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets pdl_17/z4]
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets pdl_18/z4]
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets pdl_19/z4]
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets pdl_20/z4]
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets pdl_21/z4]
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets pdl_22/z4]
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets pdl_23/z4]
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets pdl_24/z4]
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets pdl_25/z4]
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets pdl_26/z4]
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets pdl_27/z4]
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets pdl_28/z4]
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets pdl_29/z4]
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets pdl_30/z4]
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets pdl_31/z4]
