...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/vinhphat-josh/Repos/Chaos_Based_Symmetric_Image_Encryption/vivado/ip_repo/edit_chaos_crypto_engine_v1_0.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
