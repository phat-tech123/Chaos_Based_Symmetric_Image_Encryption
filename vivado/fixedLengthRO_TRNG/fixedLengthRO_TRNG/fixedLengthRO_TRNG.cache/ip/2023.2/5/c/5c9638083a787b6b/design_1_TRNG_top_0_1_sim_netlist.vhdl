...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_RO is
  ...
  attribute DONT_TOUCH of z0 : signal is std.standard.true;
  signal z1 : STD_LOGIC;
...
\RO_GEN[0].my_ro_inst\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_RO
     port map (
      ...
      Q(2 downto 0) => \pdl_ctrl_reg[0]_0\(2 downto 0),
      enable => enable,
      \in\ => ro_feedback(0),
      \out\ => ro_feedback(0)
    );
\RO_GEN[1].my_ro_inst\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_RO_0
     port map (
      ...
      Q(2 downto 0) => \pdl_ctrl_reg[1]_1\(2 downto 0),
      enable => enable,
      \in\ => ro_feedback(1),
      \out\ => ro_feedback(1)
    );
\RO_GEN[2].my_ro_inst\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_RO_1
     port map (
      ...
      Q(2 downto 0) => \pdl_ctrl_reg[2]_2\(2 downto 0),
      enable => enable,
      \in\ => ro_feedback(2),
      \out\ => ro_feedback(2)
    );
\RO_GEN[3].my_ro_inst\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_RO_2
     port map (
      ...
      Q(2 downto 0) => \pdl_ctrl_reg[3]_3\(2 downto 0),
      enable => enable,
      \in\ => ro_feedback(3),
      \out\ => ro_feedback(3)
    );
\RO_GEN[4].my_ro_inst\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_RO_3
     port map (
      ...
      Q(2 downto 0) => \pdl_ctrl_reg[4]_4\(2 downto 0),
      enable => enable,
      \in\ => ro_feedback(4),
      \out\ => ro_feedback(4)
    );
\RO_GEN[5].my_ro_inst\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_RO_4
     port map (
      ...
      Q(2 downto 0) => \pdl_ctrl_reg[5]_5\(2 downto 0),
      enable => enable,
      \in\ => ro_feedback(5),
      \out\ => ro_feedback(5)
    );
\RO_GEN[6].my_ro_inst\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_RO_5
     port map (
      ...
      Q(2 downto 0) => \pdl_ctrl_reg[6]_6\(2 downto 0),
      enable => enable,
      \in\ => ro_feedback(6),
      \out\ => ro_feedback(6)
    );
\RO_GEN[7].my_ro_inst\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_RO_6
     port map (
      ...
      Q(2 downto 0) => \pdl_ctrl_reg[7]_7\(2 downto 0),
      enable => enable,
      \in\ => ro_feedback(7),
      \out\ => ro_feedback(7)
    );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_TRNG_top is
  ...
  attribute SOFT_HLUTNM of \word_cnt[10]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \word_cnt[11]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \word_cnt[12]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \word_cnt[13]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \word_cnt[14]_i_2\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \word_cnt[1]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \word_cnt[2]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \word_cnt[3]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \word_cnt[4]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \word_cnt[5]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \word_cnt[6]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \word_cnt[7]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \word_cnt[8]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \word_cnt[9]_i_1\ : label is "soft_lutpair15";
