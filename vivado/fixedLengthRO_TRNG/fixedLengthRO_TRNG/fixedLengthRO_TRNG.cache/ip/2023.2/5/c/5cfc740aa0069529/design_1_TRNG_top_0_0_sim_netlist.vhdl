...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_TRNG_top is
  ...
  attribute SOFT_HLUTNM of \word_cnt[0]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \word_cnt[1]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \word_cnt[4]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \word_cnt[5]_i_2\ : label is "soft_lutpair3";
begin
...
\word_cnt[7]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8000000000000000"
    )
        port map (
