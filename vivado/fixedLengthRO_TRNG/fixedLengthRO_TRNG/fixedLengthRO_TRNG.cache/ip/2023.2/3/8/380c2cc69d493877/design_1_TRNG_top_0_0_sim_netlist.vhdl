...
\RO_GEN[0].my_ro_inst\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_RO
     port map (
      ...
      Q(2 downto 0) => pdl_ctrl_reg(2 downto 0),
      enable => enable,
      \in\ => ro_feedback(0),
      \out\ => ro_feedback(0)
    );
...
\pdl_ctrl[0]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\pdl_ctrl[1]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"78"
    )
        port map (
...
\pdl_ctrl[2]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"6AAA"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_TRNG_top is
  ...
  attribute SOFT_HLUTNM of \word_cnt[1]_i_1\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \word_cnt[5]_i_2\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \word_cnt[6]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \word_cnt[7]_i_2\ : label is "soft_lutpair3";
begin
...
\word_cnt[5]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"2AAAAAAA80000000"
    )
        port map (
...
\word_cnt[5]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\word_cnt[6]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"82"
    )
        port map (
...
\word_cnt[7]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\word_cnt[7]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"D200"
    )
        port map (
