...
HD_PWD='/home/vinhphat-josh/Repos/Chaos_Based_Symmetric_Image_Encryption/vivado/TRNG/TRNG/TRNG.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TRNG_Module.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TRNG_Module.tcl -notrace
