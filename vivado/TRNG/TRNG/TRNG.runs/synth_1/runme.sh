...
HD_PWD='/home/vinhphat-josh/Repos/Chaos_Based_Symmetric_Image_Encryption/vivado/TRNG/TRNG/TRNG.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TRNG_Module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TRNG_Module.tcl
